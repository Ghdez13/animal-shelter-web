...
const Hero = () => {
  ...
  return (
    <section className="w-full">
      {/* === Mobile version === */}
<div className="relative w-full min-[1200px]:hidden">
  {/* Background image */}
  <img
    key={currentIndex}
...
<div className="hidden min-[1200px]:flex min-[1200px]:relative justify-center bg-transparent py-10">
  {/* Centered container with the same width and padding as the footer */}
  <div className="max-w-6xl w-full flex gap-10 px-6 relative">
